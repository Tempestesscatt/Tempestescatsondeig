...
def processar_dades_sondeig(p_profile, T_profile, Td_profile, u_profile, v_profile, h_profile):
    """
    Versió Definitiva i Indestructible v2.0.
    Gestiona les dependències entre paràmetres i assegura que cada càlcul es realitzi
    només si els seus inputs són vàlids, evitant errors en cadena.
    """
    ...
    with parcel_lock:
        ...
        try:
            ...
            sfc_prof = None # Si falla, ho gestionarem més endavant

        # --- 3. CÀLCULS INDIVIDUALS I ROBUSTS ---
        ...
        # Paràmetres que depenen dels perfils de parcel·la
        ...
        # Paràmetres que depenen de la capa de barreja i MUCAPE
        try:
        ...
        # Paràmetres Cinemàtics (Vent i Cisallament)
        try:
        ...
        # Paràmetres que depenen del moviment de la tempesta (Helicitat)
        ...
        # Paràmetres de Capa Efectiva (els més delicats)
        try:
        ...
        # Paràmetres Compostos (depenen de la capa efectiva)
        try:
