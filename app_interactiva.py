...
# AFEGEIX AQUESTA LÍNIA JUST A SOBRE
st.cache_data.clear()
...
# LÍNIA CLAU RESTAURADA: Creem la variable global que conté el mapa
...
(Aquí aniria la resta del teu prompt detallat, que he omès per brevetat)
"""
    return resum_final
